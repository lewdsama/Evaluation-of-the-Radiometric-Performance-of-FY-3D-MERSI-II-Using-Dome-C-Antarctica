...
def plot_data(results):
    ...
    vertical_lines = [0.25, 0.5, 1, 1.25,1.5,1.75, 2.0, 2.25, 2.5, 2.75]
    ...
    ax.set_xticks([i * 0.05 for i in range(0, 60)], minor=True)  # 设置刻度线位置
    ax.set_xticks([i * 0.25 for i in range(1,13)])  # 设置每500的刻度线为次要刻度线
